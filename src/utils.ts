...
export type ConfigOptionsWithFlatConfig = ConfigOptions
  & Pick<Linter.FlatConfig, 'rules' | 'languageOptions' | 'linterOptions' | 'settings'>
...
export async function config(
  ...
  ...configs: Array<undefined | null | false | MaybeArray<Linter.FlatConfig> | CreateFlatConfig | AsyncCreateFlatConfig >
