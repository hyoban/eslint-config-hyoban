...
/* eslint-typegen-hash: 04w2bl17OL */
...
export interface RuleOptions {
  ...
  /**
   * No extra space in jsx expression
   * @see https://github.com/hyoban/eslint-plugin-hyoban/blob/main/src/rules/no-extra-space-jsx-expression.
   */
  'hyoban/no-extra-space-jsx-expression'?: Linter.RuleEntry<[]>
  /**
   * Prefer early return pattern to clean if else statement
   * @see https://github.com/hyoban/eslint-plugin-hyoban/blob/main/src/rules/prefer-early-return.
   */
...
type TypescriptEslintBlockSpacing = []|[("always" | "never")]|[("always" | "never"), ("always" | "never")]
// ----- @typescript-eslint/brace-style -----
type TypescriptEslintBraceStyle = []|[("1tbs" | "stroustrup" | "allman")]|[("1tbs" | "stroustrup" | "allman"), {
  allowSingleLine?: boolean
}]|[("1tbs" | "stroustrup" | "allman"), {
  allowSingleLine?: boolean
}, ("1tbs" | "stroustrup" | "allman")]|[("1tbs" | "stroustrup" | "allman"), {
  allowSingleLine?: boolean
}, ("1tbs" | "stroustrup" | "allman"), {
  allowSingleLine?: boolean
}]
// ----- @typescript-eslint/class-literal-property-style -----
type TypescriptEslintClassLiteralPropertyStyle = []|[("fields" | "getters")]|[("fields" | "getters"), ("fields" | "getters")]
...
type _TypescriptEslintCommaDangleValue = ("always-multiline" | "always" | "never" | "only-multiline" | "always-multiline" | "always" | "never" | "only-multiline")
type _TypescriptEslintCommaDangleValueWithIgnore = ("always-multiline" | "always" | "never" | "only-multiline" | "ignore" | "always-multiline" | "always" | "never" | "only-multiline" | "ignore")
...
type TypescriptEslintConsistentGenericConstructors = []|[("type-annotation" | "constructor")]|[("type-annotation" | "constructor"), ("type-annotation" | "constructor")]
// ----- @typescript-eslint/consistent-indexed-object-style -----
type TypescriptEslintConsistentIndexedObjectStyle = []|[("record" | "index-signature")]|[("record" | "index-signature"), ("record" | "index-signature")]
...
type TypescriptEslintConsistentTypeDefinitions = []|[("interface" | "type")]|[("interface" | "type"), ("interface" | "type")]
...
type TypescriptEslintMethodSignatureStyle = []|[("property" | "method")]|[("property" | "method"), ("property" | "method")]
// ----- @typescript-eslint/naming-convention -----
type _TypescriptEslintNamingConventionFormatOptionsConfig = (_TypescriptEslintNamingConventionPredefinedFormats[] | null | _TypescriptEslintNamingConventionPredefinedFormats[] | null)
type _TypescriptEslintNamingConventionPredefinedFormats = ("camelCase" | "strictCamelCase" | "PascalCase" | "StrictPascalCase" | "snake_case" | "UPPER_CASE" | "camelCase" | "strictCamelCase" | "PascalCase" | "StrictPascalCase" | "snake_case" | "UPPER_CASE")
type _TypescriptEslintNamingConventionUnderscoreOptions = ("forbid" | "allow" | "require" | "requireDouble" | "allowDouble" | "allowSingleOrDouble" | "forbid" | "allow" | "require" | "requireDouble" | "allowDouble" | "allowSingleOrDouble")
type _TypescriptEslintNamingConvention_PrefixSuffixConfig = string[]
type _TypescriptEslintNamingConventionTypeModifiers = ("boolean" | "string" | "number" | "function" | "array" | "boolean" | "string" | "number" | "function" | "array")
...
type _TypescriptEslintPaddingLineBetweenStatementsPaddingType = ("any" | "never" | "always" | "any" | "never" | "always")
...
type TypescriptEslintQuotes = []|[("single" | "double" | "backtick")]|[("single" | "double" | "backtick"), ("avoid-escape" | {
  avoidEscape?: boolean
  allowTemplateLiterals?: boolean
})]|[("single" | "double" | "backtick"), ("avoid-escape" | {
  avoidEscape?: boolean
  allowTemplateLiterals?: boolean
}), ("single" | "double" | "backtick")]|[("single" | "double" | "backtick"), ("avoid-escape" | {
  avoidEscape?: boolean
  allowTemplateLiterals?: boolean
}), ("single" | "double" | "backtick"), ("avoid-escape" | {
  avoidEscape?: boolean
...
type TypescriptEslintReturnAwait = []|[("in-try-catch" | "always" | "never")]|[("in-try-catch" | "always" | "never"), ("in-try-catch" | "always" | "never")]
